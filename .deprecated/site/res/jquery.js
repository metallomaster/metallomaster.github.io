      ...
      (g = se.select =
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === c.length)) {
            ...
            for (i = G.needsContext.test(e) ? 0 : o.length; i--;) {
        ...
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (a = v.handle) ||
              (a = v.handle =
                function (e) {
                  if ('undefined' != typeof S && S.event.triggered !== e.type)
    ...
    run: function (e) {
      ...
      return (
        (this.pos = this.options.duration
          ? (t = S.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration))
          : (t = e)),
    ...
    return (
      S.fx.off
        ...
        : 'number' != typeof r.duration &&
          (r.duration = r.duration in S.fx.speeds ? S.fx.speeds[r.duration] : S.fx.speeds._default),
