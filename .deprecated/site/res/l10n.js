(function (x) {
  ...
  l(
    'admin_manager_ads_01',
    'Управляйте Вашими сайтами с мобильных устройств с помощью приложения для WebSite X5 Professional с еще более мощным функционалом.',
  );
  l(
    'admin_manager_ads_02',
    'Введите имя пользователя или отсканируйте QR-код с помощью Вашего устройства.',
  );
  l(
    'admin_manager_ads_03',
    'Вы можете добавить неограниченное количество сайтов и управлять ими с помощью всего лишь нескольких нажатий.',
  );
  l(
    'admin_manager_ads_04',
    'Установите push-уведомления, чтобы не пропускать важную информацию с Ваших сайтов.',
  );
  l(
    'admin_manager_ads_05',
    'Следите за заказами, проверяйте наличие товаров на складе, отвечайте на комментарии пользователей. У Вас всё под рукой.',
  );
  l(
    'admin_manager_download',
    'Установите Приложение, доступное в основных интернет-магазинах, или отсканируйте QR-код:',
  );
  l(
    'admin_manager_introduction',
    'Получите доступ к Панели Управления всех Ваших сайтов со смартфона или планшета с помощью приложения WebSite X5 Manager.',
  );
  l('admin_manager_name', 'WebSite X5 Manager');
  l(
    'admin_manager_site_connect_info',
    'Отройте WebSite X5 Manager и отсканируйте этот QR-код, чтобы добавить ваш сайт "[WEBSITENAME]".',
  );
  l(
    'admin_manager_subtitle',
    'Приложение WebSite X5 для управления сайтами даже с мобильного устройства.',
  );
  l('admin_post_select', 'Выберите запись:');
  l('admin_product_select', 'Выберите товар:');
  l('admin_test_database', 'Настройки MySQL');
  l(
    'admin_test_database_suggestion',
    'Попросите своего хостинг-провайдера проверить настройки вашей базы данных',
  );
  l('admin_test_email', 'Проверьте настройки e-mail');
  l('admin_test_folder', 'Путь к публичной папке на сервере');
  l(
    'admin_test_folder_suggestion',
    'Уточните у хостинг-провайдера путь к папке с доступом на чтение/запись. Эта папка должна иметь атрибуты доступа 777',
  );
  l('admin_test_notpassed', 'Не превышены');
  l(
    'admin_test_php_version',
    'Версия PHP (Наиболее ранняя требуемая версия [PHP_MIN_VERSION]): [PHP_ACTUAL_VERSION]',
  );
  l('admin_test_session', 'Поддержка сессии');
  l(
    'admin_test_session_suggestion',
    'Обратитесь к своему хостинг-провайдеру для получения дополнительной информации о настройках сессии',
  );
  ...
  l(
    'blog_offline_message',
    'Эта функция будет доступна только когда ваш сайт будет выложен в Интернет.',
  );
  ...
  l(
    'blog_send_confirmation',
    'Сообщение опубликовано!<br />Ваше сообщение появится после проверки администратором сайта.',
  );
  ...
  l(
    'browser_compat_1_warning',
    'Возможно, Ваш браузер не поддерживает функции, требуемые для визуализации этого Сайта.',
  );
  ...
  l(
    'cart_category_descr',
    'Выберите продукт из следующего списка и введите необходимое количество.',
  );
  ...
  l(
    ...
    'Чтобы добавить товары в корзину, перейдите на сайт и нажмите «Добавить в корзину», когда найдёте интересующий Вас товар.',
  );
  ...
  l(
    'cart_err_offline_email',
    'Заказ будет обработан и отправлен по адресу [MAIL], как только ваш сайт будет доступен в Интернет.',
  );
  ...
  l(
    ...
    'Выбранного количества изделия [PRODUCTNAME] нет в наличии. Максимальное имеющееся в наличии количество [PRODUCTNAME].',
  );
  l('cart_product_unknown', 'Этого продукта нет в списке');
  l('cart_provisional_amount', 'Предварительная сумма');
  l(
    'cart_provisional_amount_info',
    'Общая сумма, указанная в данном итоге по заказу, является предварительной. <br> Вы сможете указать более подробную информацию до завершения заказа.',
  );
  ...
  l(
    'cart_step0_cartlist',
    'В таблице перечислены все товары из Корзины и указана суммарная стоимость вашего заказа.',
  );
  l('cart_step0_gonext', 'Вперед');
  l('cart_step1', 'Шаг 1 - Данные покупателя');
  l(
    'cart_step1_descr',
    "Заполните следующую форму своими данными. Не забудьте указать информацию во всех обязательных полях.<br />Для продолжения нажмите кнопку '[FIELD]'.",
  );
  l('cart_step1_gonext', 'Вперед');
  l('cart_step1_header', 'данные пользователя');
  l('cart_step2', 'Шаг 2 - Данные покупателя');
  l(
    'cart_step2_descr_login',
    'Для продолжения заказа войти в систему или выполнить новую регистрацию.',
  );
  l('cart_step2_header', 'Доставка и оплата');
  l(
    'cart_step2_shiplist',
    "Выберите желаемый метод доставки и оплаты, затем нажмите на кнопку '[FIELD]'.",
  );
  ...
  l(
    'cart_step4_descr',
    'Ваш заказ отправлен и будет обработан в ближайшее время.<br /><br /> На указанный вами e-mail будет отправлено письмо, содержащее все данные о заказе, а также указания по доставке и реквизиты для оплаты.<br /><br />Для отслеживания своего заказа, пожалуйста, запомните его номер:',
  );
  ...
  l('country_names', [
    ...
    'О-в Буве',
    'Бразилия',
    'Британская терртория в Индийском океане',
    'Бруней-Даруссалам',
    'Болгария',
    'Буркина-Фасо',
    'Бурунди',
  ...
  l(
    'error_notsupported_audio',
    'Аудио не может воспроизводиться в этом браузере. Попробуйте использовать другой браузер.',
  );
  l(
    'error_notsupported_video',
    'Видео не может воспроизводиться в этом браузере. Попробуйте использовать другой браузер.',
  );
  ...
  l(
    'form_js_error',
    'Необходимо активировать JavaScript! <br />Вы будете перенаправлены на предыдущую страницу через 5 секунд...',
  );
  ...
  l(
    'private_area_account_not_allowed',
    'Ваш аккаунт не позволяет получить доступ к выбранной странице',
  );
  ...
  l(
    'private_area_newregistration_body',
    'Новый пользователь зарегистрирован на [FIELD]. Данные пользователя здесь.',
  );
  l(
    'private_area_newregistration_subject',
    'Новый пользователь зарегистрирован в зоне для зарегистрированных пользователей как[FIELD]',
  );
  l('private_area_not_validated', 'Ваш аккаунт пока не подтвержден.');
  l('private_area_password', 'Пароль');
  l(
    'private_area_password_recovery_body_admin',
    'Пользователь <b>[FIELD]<\/b> потерял пароль для доступа в зону зарегистрированных пользователей на сайте [URL].',
  );
  l(
    'private_area_password_recovery_body_user',
    'Вы запросили восстановление пароля. Вот данные вашей учетной записи.',
  );
  ...
  l(
    'private_area_password_recovery_mail_click_on_btn',
    'Нажмите на кнопку ниже, чтобы перейти на страницу, где Вы можете установить новый пароль:',
  );
  l(
    'private_area_password_recovery_mail_click_on_link',
    'Или скопируйте следующую ссылку в Ваш браузер:',
  );
  l('private_area_password_recovery_mail_greeting', 'Здравствуйте');
  l(
    'private_area_password_recovery_mail_ignore_this_mail',
    'Если Вы не пытались изменить свой пароль, то просто игнорируйте это сообщение. Возможно, кто-то ввёл Ваш адрес электронной почты по ошибке.',
  );
  l('private_area_password_recovery_mail_subject', 'Форма запроса сброса пароля {0}');
  l(
    'private_area_password_recovery_mail_your_mail_is',
    'Напоминаем, адрес электронной почты, на который Вы зарегистрированы:',
  );
  l(
    'private_area_password_recovery_mail_your_request_received',
    'был получен Ваш запрос на сброс пароля.',
  );
  ...
  l(
    'private_area_validation_sent',
    'Мы отправили вам письмо для подтверждения вашей учетной записи.',
  );
  ...
  l(
    'row_video_offline_error_notsupported',
    'Фоновое видео в Стиле Полос не может воспроизводиться в этом браузере. Попробуйте использовать другой браузер.',
  );
  l('search_blog', 'Блог');
  ...
  l(
    'wsx5manager_ads',
    'Войдите в Панель управления сайтами со смартфона или планшета с помощью приложения WebSite X5 Manager.',
  );
