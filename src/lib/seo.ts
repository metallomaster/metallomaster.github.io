...
export interface PageSeo {
  ...
  /**
   * Страница не для поиска (например, 404): отдаём noindex и не ставим canonical.
   * Canonical на несуществующий адрес — противоречивый сигнал: страница просит
   * считать каноническим URL, которого в карте сайта нет.
   */
  noindex?: boolean;
}
