 ...
 * Виджеты помечают ссылки <a data-lightbox-group="…" href="полноразмер">,
 * разметка диалога — ui/lightbox.astro (вставляется один раз на страницу).
 */
...
export function initLightbox(root: HTMLElement): void {
  ...
  // Делегирование: ссылки размечаются в любом виджете внутри root
